  ...
  app: {
    ...
    head: {
      ...
      link: [
        ...
        // Preconnect to deferred analytics (cuts RTT when script loads)
        ...(!import.meta.dev
          ? [{ rel: 'preconnect', href: 'https://analytics.elitetrackr.com', crossorigin: '' }]
          : []),
        ...
        // JetBrains Mono is self-hosted by @nuxt/fonts (used for monospace UI accents)
      ],
    },
  },
})
